...
$TaskName = "PetFoodRecallUpdater_User"
...
Register-ScheduledTask -Action $Action -Trigger $Trigger -TaskName $TaskName -Description "Updates pet food recall data daily (User Level)"
